...
| marital_status   |  VARCHAR(100)  | The marital status of the customer (e.g., 'Married', 'Single').                              |
| gender           |  VARCHAR(100)  | The gender of the customer (e.g., 'Male', 'Female', 'n/a').                                  |
...
| product_number      | NVARCHAR(100) | A structured alphanumeric code representing the product, often used for categorization or inventory. |
...
| Column Name     | Data Type     | Description                                                                                   |
|-----------------|---------------|-----------------------------------------------------------------------------------------------|
| order_number    | NVARCHAR(100) | A unique alphanumeric identifier for each sales order (e.g., 'SO54496').                      |
